# Code book
This paper describes the variables of tidy dataset. Firstly, describes original data, which were processed to new form. Next, tidy dataset.
...
The set of variables that were estimated from these signals are (which was used in final data): 
...
## Tidy data
Values were processed and reduced to next values:
